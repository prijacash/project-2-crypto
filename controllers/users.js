...
router.post('/', async (req, res) => {
    try {
        // hash the password the req.body
        ...
        // if the user was found.. send them to  
        if(!created) {
            console.log('user exists already')
            res.redirect('/users/login?message=Please log into your account')
        } else {
...
router.get('/profile', (req, res) => {
    ...
    // otherwise, show them their profile
        ...
        db.insight.findAll({
                ...
                console.log('THIS IS SINIGHT', insight)
